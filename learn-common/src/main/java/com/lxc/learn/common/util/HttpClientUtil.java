...
public class HttpClientUtil {
      ...
      try {
        ...
        try {
          if (entity != null) {
            ...
            log
                .info("[HttpUtils Post]Debug response, url :" + url + " , response string :" + str);
            return str;
          }
        } finally {
          if (entity != null) {
  ...
  public static String invokeGet(String url, Map<String, String> params, String encode,
    ...
    try {
      ...
      log.info(String.format("[HttpUtils Get]Debug url:%s , response string %s:", sb.toString(),
          responseString));
    } catch (SocketTimeoutException e) {
      log
          .error(String.format("[HttpUtils Get]invoke get timout error, url:%s", sb.toString()), e);
      return responseString;
    } catch (Exception e) {
